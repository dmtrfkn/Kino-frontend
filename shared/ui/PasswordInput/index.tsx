  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.wrapper}>
        ...
        {/* <button className={styles.button} onClick={() => setPasswordVisible((prev) => !prev)}>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
